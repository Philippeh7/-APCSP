...
public class Lab16e
{
	...
	{
		Histogram test = new Histogram(new char[]{'a','b','c'},"H:\\hansenestruchjava\\Unit 10\\src\\lab16e1.dat");
		...
		out.println("\n");
		out.println(test);
		Histogram test1 = new Histogram(new char[]{'d','e','f'},"H:\\hansenestruchjava\\Unit 10\\src\\lab16e2.dat");
		...
		out.println("\n");
		out.println(test1);
		Histogram test2 = new Histogram(new char[]{'g','h','i'},"H:\\hansenestruchjava\\Unit 10\\src\\lab16e3.dat");
